...
@endif
@php
    $url = ($config['method'] == 'create') ? route('member.save') : route('member.update', 
    $member->id);
@endphp
                            ...
                            <div class="col-lg-5">
                                <div class="form-row">
                                    ...
                                    <input 
                                        ...
                                        ($member->day_of_birth ?? null) ?
                                        date('Y-m-d', strtotime($member->day_of_birth)):'' )}}"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <select name="gender" class="form-control setupSelect2">
                                        @foreach($genderLabels as $key => $value)
                                            <option value="{{ $key }}" {{ $key == old('gender', $member->gender) ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
