...
@endif
@php
    $url = ($config['method'] == 'create') ? route('trainer.save') : route('trainer.update', 
    $trainer->id);
@endphp
                            ...
                            <div class="col-lg-5">
                                <div class="form-row">
                                    ...
                                    <input 
                                        ...
                                        ($trainer->day_of_birth ?? null) ?
                                        date('Y-m-d', strtotime($trainer->day_of_birth)):'' )}}"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <select name="gender" class="form-control setupSelect2">
                                        @foreach($genderLabels as $key => $value)
                                            <option value="{{ $key }}" {{ $key == old('gender', $trainer->gender) ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input 
                                        ...
                                        name="avatar" 
                                        class="form-control" 
                                        value="{{old('avatar',($trainer->avatar) ?? '')}}" 
                                        placeholder=""
                                        autocomplete="off"
                                    >
                                </div>
