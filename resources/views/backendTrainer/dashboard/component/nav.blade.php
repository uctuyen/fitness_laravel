<div class="row border-bottom">
    <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li>
                <span class="m-r-sm text-muted welcome-message">Chúc huấn luyện viên {{ Auth::guard('trainer')->user()->first_name }} {{ Auth::guard('trainer')->user()->last_name }}  một ngày tốt lành. </span>
            </li>
            </li>
            <li class="dropdown">
